...
# structure: [ { "query": str, "embedding": np.ndarray, "answer": str, "sources": List } ]
...
def get_semantic_cache(
    ...
    best_match = None
    highest_sim = -1.0
    for cached_item in _SEMANTIC_CACHE:
...
def set_semantic_cache(query: str, answer: str, sources: List, query_emb: np.ndarray = None):
    ...
    logger.info("Tier 2 (Semantic Cache) set for query")
